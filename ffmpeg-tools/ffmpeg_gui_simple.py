#!/usr/bin/env python3
"""
FFmpeg Image Sequence to MP4 Converter (Simplified)
A GUI application for VFX professionals
"""
...
class FFmpegConverterGUI:
    ...
    def setup_ui(self):
        ...
        # Instructions
        instructions = tk.Label(main_frame, text="Drag and drop a folder here, or use Browse button to select folder", 
        ...
        self.convert_btn = tk.Button(button_frame, text="START CONVERSION", command=self.start_conversion, 
                                    bg='#4CAF50', fg='white', relief=tk.FLAT, font=("Arial", 14, "bold"), 
                                    width=20, height=2)
    ...
    def auto_generate_output(self, input_path):
        """Auto-generate output filename in the same folder"""
        folder_name = os.path.basename(input_path)
        output_path = os.path.join(input_path, f"{folder_name}.mp4")
